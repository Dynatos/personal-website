...
export default class UserInputForm extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <form id="runescape-max-hit-form" className="runescape-user-input-form">
          <fieldset className="runescape-max-hit-strength-level">
            <legend>Strength Level</legend>
            <input name="strength-level" type="number" placeholder="1" min="1" max="99" id="osrs-strength" />
          </fieldset>
  
          
          <fieldset className="runescape-max-hit-prayer">
            <legend>Prayer</legend>
            <select name="prayer" type="list" id="osrs-prayer">
              <option value="false">None</option>
              <option value="burst_of_strength">Burst of Strength (5% Melee)</option>
              <option value="sharp_eye">Sharp Eye (5% Range)</option>
              <option value="superhuman_strength">Superhuman Strength (10% Melee)</option>
              <option value="hawk_eye">Hawk Eye (10% Range)</option>
              <option value="ultimate_strength">Ultimate Strength (15% Melee)</option>
              <option value="eagle_eye">Eagle Eye (15% Range)</option>
              <option value="chivalry">Chivalry (18% Melee)</option>
              <option value="piety">Piety (23% Melee)</option>
              <option value="rigour">Rigour (23% Range)</option>
            </select>
          </fieldset>
          
          
          <fieldset className="runescape-max-hit-strength-boost">
            <legend>Strength Buff</legend>
            <select name="strength-boost" type="list" id="osrs-boost" onChange={(e) => {checkDharoks(e); checkDragonBattleaxe(e);}}>
              <option value="false">None</option>
            ...
            <input type="number" id="osrs-attack" min="1" max="120" style={{display: 'none'}} />
            
            <label id="osrs-defence-label" htmlFor="osrs-defence"  style={{display: 'none'}}>
              Defence
            </label>
            <input type="number" id="osrs-defence" min="1" max="120" style={{display: 'none'}} />
            
            <label id="osrs-range-label" htmlFor="osrs-range"  style={{display: 'none'}}>
              Range
            </label>
            <input type="number" id="osrs-range" min="1" max="120" style={{display: 'none'}} />
            
            <label id="osrs-magic-label" htmlFor="osrs-magic"  style={{display: 'none'}}>
              Magic
            </label>
            <input type="number" id="osrs-magic" min="1" max="120" style={{display: 'none'}} />
          </fieldset>
  
          
          <fieldset className="runescape-max-hit-stance">
            <legend>Combat Stance</legend>
          ...
          <fieldset className="runescape-max-hit-void">
            <legend>Void Knight Armour</legend>
          ...
          <fieldset className="runescape-max-hit-other-equipment">
          ...
          <fieldset className="runescape-max-hit-equipment-strength-bonus">
