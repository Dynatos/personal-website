...
class EquipmentItems extends Component {
  ...
  render() {
    let { topItems, uniqueClassNumber } = this.props;
...
// prop that it was handed in the component where it was called. Also sets the css classes based on the finalColumn prop
    return (
      <div className={"equipment--item-names equipment--item" + uniqueClassNumber}>
...
EquipmentItems.propTypes = {
  topItems: PropTypes.object,
  uniqueClassNumber: PropTypes.number,
};
