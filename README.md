...
Another tool for the MMORPG Runescape (Oldschool servers). I made this tool to better understand how the internal mechanisms of the game work, and to practice creating a readable data pipeline with encapsulated functions that have self-explanatory names. Having a strict pipeline is required to get an accurate output.
